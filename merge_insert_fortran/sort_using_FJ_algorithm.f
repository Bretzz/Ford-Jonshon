...
c
c Glossary:
c Element-N = array of 2ˆN integers
...
c	write(*,*) 'Reading sequence from standard input'
        do i = 1, max_n
	  read(*,*,END=9001) seq_0(i)
        enddo
 9001   continue
	N=i-1
c        write(*,*) 'Reading:', N
...
c        write(*,*) ' Number of integers in the sequence:', N
c        write(*,'(a,20i8)') 'START: ', (seq_0(j),j=1,20)

c        call cputime(t1)
c        start_loop=t1
c	 write(*,'(a,f20.5)') ' START at:', start_loop
...
c        call cputime(t1)
c        end_loop=t1
c 	 total_time=end_loop-start_loop
c        write(*,'(a,f20.5)') ' END at:', end_loop
c	 write(*,'(a,f20.5)') ' TOTAL TIME:', total_time



c        write(*,'(a,20i8)') 'NEW:   ', (seq_2(j),j=1,20)
